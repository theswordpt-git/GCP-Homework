...
<body>
  ...
  <h2>A car included for free!</h2>
  <figure>
    <img src="https://dwhojh9l2shw5.cloudfront.net/wp-content/uploads/2020/11/24160223/Clunker.jpg" alt="high performance racing!" style="max-width:600px; width:100%; display:block; margin:1rem 0;">
    <figcaption>Everbody gets a fancy car!</figcaption>
  </figure>
</body>
</html>
EOF
